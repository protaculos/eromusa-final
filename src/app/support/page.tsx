    ...
    <div className="min-h-screen">
      <div className="pt-8 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          ...
          <section className="bg-[#161827] border border-[#1E2130] rounded-2xl p-8">
            <h2 className="text-xl font-semibold text-white mb-4">{t('support.faq')}</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-white/80 font-medium mb-1">{t('support.faq1q')}</h3>
                <p>{t('support.faq1a')}</p>
              </div>
              <div>
                <h3 className="text-white/80 font-medium mb-1">{t('support.faq2q')}</h3>
                <p>{t('support.faq2a')}</p>
              </div>
              <div>
                <h3 className="text-white/80 font-medium mb-1">{t('support.faq3q')}</h3>
                <p>{t('support.faq3a')}</p>
              </div>
              <div>
                <h3 className="text-white/80 font-medium mb-1">{t('support.faq4q')}</h3>
                <p>{t('support.faq4a')}</p>
              </div>
            </div>
          </section>
